...
Method for confirming same neuron across multiple ephys recordings based on paper "Representational Drift in Primary Olfactory Cortex" by Carl Schoonover (https://pubmed.ncbi.nlm.nih.gov/34108681/).
